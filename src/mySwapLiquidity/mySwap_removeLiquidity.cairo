...
trait IRouter {
    ...
    fn withdraw_liquidity(
        pool_id: u128, shares_amount: u128, amount_min_a: u128, amount_min_b: u128, 
    ) -> (u128, u128, u128, u128);
    fn swap(
...
mod jedi_withdraw_liquidity {
    ...
    #[event]
    fn Zapped_out(
        sender: ContractAddress, pool_id: u128, to_token: ContractAddress, tokens_rec: u128
    ) {}
    ...
    fn withdraw_tokens(tokens: Array::<ContractAddress>) {
        ...
        let amount = IERC20Dispatcher {
            contract_address: ierc20_address
    ...
    fn _remove_liquidity(
        pool_id: u128, from_pair_address: ContractAddress, incoming_lp: u128
    ) -> (u128, u128) {
